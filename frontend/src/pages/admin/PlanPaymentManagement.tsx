            ...
            <tbody className="divide-y divide-slate-100">
              {(purchasesQuery.data?.data ?? []).map((purchase) => (
                <tr key={purchase.id}>
                  ...
                  <td className="px-4 py-4"><p className="font-medium uppercase">{purchase.payment_method}</p><p className="break-all text-slate-500">Account: {purchase.payment_reference}</p></td>
