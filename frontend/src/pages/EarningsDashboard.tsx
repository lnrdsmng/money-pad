    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6 sm:space-y-8">
          {activeRequests.some((request) => ['pending_review', 'approved'].includes(request.status)) && (
          <div className="flex items-start gap-3 rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm text-blue-900 dark:border-blue-900 dark:bg-blue-950/30 dark:text-blue-200">
            <AlertCircle className="mt-0.5 h-4 w-4 shrink-0" />
            <p>
              Previous payouts are held per income source while processing. Processing takes 1–7 business days,
              Monday–Saturday. Reader and author payouts resume independently after their previous payout is settled.
            </p>
          </div>
          )}
