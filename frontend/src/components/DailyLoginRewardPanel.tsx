      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between pr-6">
        ...
        <div className="flex flex-wrap gap-2">
          {days.map((day) => (
            ...
            >
              ...
              {day.status === 'upcoming' ? (
                <p className="mt-0.5 sm:mt-1 font-bold text-[11px] sm:text-xs text-amber-700 dark:text-amber-400">? Surprise</p>
              ) : (
        ...
        {availableDay && (
          ...
          >
            ...
            Claim {availableDay.amount} Coins ({formatPesoFromCoins(availableDay.amount ?? '0')})
          </button>
        )}
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-stone-600 dark:text-stone-400 mt-0.5">
            {availableDay
              ? `Day ${availableDay.day} ready to claim (${availableDay.amount} coins)`
              : claimedToday
      ...
      <div className="w-full sm:w-auto shrink-0">
        {availableDay ? (
          ...
          >
            ...
            Claim {availableDay.amount} coins
          </button>
        ) : claimedToday ? (
